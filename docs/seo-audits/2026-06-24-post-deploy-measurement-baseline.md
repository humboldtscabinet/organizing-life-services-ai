...
_Generated 2026-06-24 00:18 UTC_
...
**Window:** `2026-05-27 -> 2026-06-23`

| Metric | Prior | Current | Delta |
|---|---:|---:|---:|
| Sessions | 1,443 | 776 | -46.2% |
| keyEvents | 2,210 | 1,246 | -43.6% |
...
|---|---|---:|---:|
| `page_view` | passive_or_pageview | 1,171 | 1,171 |
| `ads_conversion_Contact_Page_load_https_1` | passive_or_pageview | 68 | 68 |
| `form_submit` | lead_intent | 7 | 7 |
| `session_start` | passive_or_pageview | 0 | 778 |
| `first_visit` | passive_or_pageview | 0 | 642 |
| `user_engagement` | passive_or_pageview | 0 | 530 |
| `scroll` | passive_or_pageview | 0 | 125 |
...
**GSC window:** `2026-05-25 -> 2026-06-21`

| Priority | Query | Page | Impr. | Clicks | Pos. | Lead | Action |
|---:|---|---|---:|---:|---:|---|---|
| 1 | `estate sale organizers` | `/` | 247 | 0 | 14.4 | HIGH (70) | Expand homepage service-intent copy or refine homepage internal links |
| 2 | `estate sale organizers` | `/pages/estate-sale-tampa-hillsborough-county` | 70 | 0 | 18.9 | HIGH (90) | Create or improve a service-area page/section |
| 3 | `estate sale companies near me` | `/` | 92 | 0 | 18.0 | MEDIUM (55) | Expand homepage service-intent copy or refine homepage internal links |
| 4 | `estate sales palm harbor` | `/` | 112 | 0 | 8.6 | HIGH (70) | Expand homepage service-intent copy or refine homepage internal links |
| 5 | `how to increase home value for appraisal` | `/blogs/news/how-to-increase-your-home-appraisal-value` | 71 | 0 | 27.1 | MEDIUM (50) | Create or refresh an educational guide |
| 6 | `estate organization service` | `/` | 69 | 0 | 10.8 | MEDIUM (50) | Expand homepage service-intent copy or refine homepage internal links |
...
| 9 | `estate cleanout services` | `/pages/estate-cleanout-services` | 44 | 0 | 16.6 | HIGH (70) | Expand matching service page with FAQs, process, and CTA |
| 10 | `estate sales tarpon springs` | `/pages/tarpon-springs-estate-sale-in-woodfield` | 69 | 0 | 7.2 | HIGH (70) | Use this demand to build/strengthen a permanent service-area page; leave legacy event shell noindexed |
| 11 | `estate sale organizers` | `/pages/13925-pathfinder-drive-tampa-florida` | 53 | 0 | 9.0 | HIGH (90) | Use this demand to build/strengthen a permanent service-area page; leave legacy event shell noindexed |
| 12 | `tampa personal property appraisers` | `/pages/personal-property-appraisal` | 61 | 0 | 8.1 | HIGH (70) | Expand appraisal page into a stronger service landing page |
| 13 | `estate sale organizers` | `/pages/estate-sale-planning` | 59 | 0 | 9.2 | HIGH (70) | Review existing page intent and title/meta alignment |
| 14 | `estate sale organizers` | `/pages/senior-services` | 59 | 0 | 9.2 | HIGH (70) | Review existing page intent and title/meta alignment |
| 15 | `estate sale planners` | `/` | 43 | 0 | 16.0 | MEDIUM (50) | Expand homepage service-intent copy or refine homepage internal links |
...
Raw JSON: `data/audit_output/post_deploy_measurement_baseline_20260624T001823Z.json`